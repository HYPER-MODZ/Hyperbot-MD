...
alpha.relayMessage(anu, buatpesan.message, { messageId: buatpesan.key.id })
	    ...
	    case 'toimage': case 'toimg': {
            ...
            case 'self': {
                if (!m.key.fromMe && !isCreator) throw mess.owner
                alpha.public = false
                m.reply('Successfully Change To Self Mode')
            }
            break
...
case 'mp4': case 'ytmp4':
            ...
            case 'leave':
               ...
               m.reply('Good Bye~ 👋').then(async res => await alpha.groupLeave(from))
            break
